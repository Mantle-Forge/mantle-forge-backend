...
if (process.argv.includes('--help') || process.argv.includes('-h')) {
  console.log(chalk.cyan('create-agent'));
  console.log('');
  console.log('Usage:');
  console.log('  npx create-agent <project-name>');
  console.log('');
  console.log('Options:');
  console.log('  -h, --help     Show this help message');
  console.log('');
  console.log('Examples:');
  console.log('  npx create-agent my-ai-bot');
  console.log('  npx create-agent trading-agent');
  process.exit(0);
}

if (!projectName) {
  console.error(chalk.red('Error: Please provide a project name.'));
  console.log(chalk.yellow('Usage: npx create-agent <project-name>'));
...
console.log(chalk.cyan(`Creating Mantle AI agent project: ${projectName}...`));
...
if (shell.test('-d', localTemplatePath)) {
  ...
  console.log(chalk.yellow('  1) Place an `agent-template/` directory next to `create-agent/`, or'));
...
console.log(chalk.cyan('  npm install -g git-agent'));
...
console.log('');
console.log(chalk.bold('Then set up MantlePush:'));
